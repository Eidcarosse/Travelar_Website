...
function App() {
  ...
  return (
    ...
    <Routes>
      <Route path='/' element={[<Home key="UndApp" title={t('Titles.Home')} description={t('Descriptions.Home')} logo={hme_logo} />, <ServicesInfo key='Index_Svcs'/>, <MwBtn/>, <InfoBanner key='IIB01' Title={t('InfoBanner.Titles.Home')} description={t('InfoBanner.Descriptions.Home')} Image={Gft_Box}/>, <About key='IA01'/>]}/>
