...
export default function ListItem(props) {
  ...
  return (
    <div className='Items_Container' >
     <span className='Cntent_Wraper'><Link className='RTL_Thd Lst_Anim' S_language={Slng} onClick={()=>{ToggleIcon() ;Scroll_Top();}} id='LinkAdd' to={props.linked}>{props.title}</Link></span>
    </div>
  )
}
